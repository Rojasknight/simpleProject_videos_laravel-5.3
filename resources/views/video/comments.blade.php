...
{{--mostrar un mensaje cuando se haya creado un comntario--}}
@if(session('message'))
...
@if(Auth::check())
    ...
    <form class="col-md-4" action="{{url('/comment')}}" method="POST">
        ...
        <input name="video_id" value="{{$video->id}}" type="hidden" required/>
        <p>
                ...
                <div class="panel panel-default comment-data">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            hace {{ \FormatTime::LongTimeFilter($comment->created_at) }}
                        </div>
                    ...
                    <div class="panel-body">
                        ...
                        @if(Auth::user()->id == $comment->user_id || Auth::user()->id == $video->user_id)
                            <div class="pull-right">
                                ...
                                <a href="#victorModal{{$comment->id}}" role="button" class="btn btn-sm btn-primary"
                                   data-toggle="modal">
                                    Eliminar </a>
